...
<div class="offer-card">
    ...
    <div class="offer-card__amount">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <span class="font-mono" style="font-size: 1.1rem; font-weight: 600;">$ <?php echo e(number_format($offer->availableAmount, 2)); ?></span>
        </div>
        <?php if($offer->reservedAmount > 0): ?>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 0.25rem;">
                <small style="color: var(--color-text-hint);">En negociación:</small>
                <small style="color: var(--color-sell); font-weight: 500;">$ <?php echo e(number_format($offer->reservedAmount, 2)); ?></small>
            </div>
        <?php endif; ?>
        <?php if($offer->availableAmount < $offer->amount): ?>
            <div style="margin-top: 0.5rem;">
                <div style="height: 4px; background: var(--color-border-soft); border-radius: 2px; overflow: hidden;">
                    ...
                    ?>
                    <div style="width: <?php echo e($percentAvailable); ?>%; height: 100%; background: linear-gradient(90deg, var(--color-buy) 0%, var(--color-primary) 100%); border-radius: 2px; transition: width 0.3s ease;"></div>
                </div>
                <small style="color: var(--color-text-hint); display: block; margin-top: 0.25rem; text-align: right;">
                    <?php echo e(round($percentAvailable)); ?>% disponible
                </small>
            </div>
        <?php endif; ?>
    </div>
...
<div id="contact-modal-<?php echo e($offer->id); ?>" class="modal-overlay" style="display:none" onclick="if(event.target === this) closeModal(<?php echo e($offer->id); ?>)">
    <div class="modal">
        <div style="text-align: center; margin-bottom: 1.5rem;">
            <span class="badge badge--<?php echo e($offer->type === 'venta' ? 'sell' : 'buy'); ?> badge--lg" style="margin-bottom: 0.75rem;">
                <?php echo e($offer->type === 'venta' ? 'VENTA' : 'COMPRA'); ?>

            </span>
            <h3 class="modal__title" style="margin-bottom: 0.25rem;">Contactar vendedor</h3>
            <p style="color: var(--color-text-muted); font-size: 0.9rem;">
                Bs. <?php echo e(number_format($offer->price, 2)); ?> por dólar
            </p>
        </div>
        ...
        <?php if($offer->contactInfo): ?>
            ...
            <div class="modal__actions" style="flex-direction: column; gap: 0.75rem;">
                <a href="tel:<?php echo e($offer->contactInfo); ?>" class="btn btn--primary">
                ...
                <a href="https://wa.me/591<?php echo e(ltrim($offer->contactInfo, '0')); ?>" target="_blank" class="btn btn--whatsapp">
                ...
                <div style="border-top: 1px solid var(--color-border); padding-top: 1rem; margin-top: 0.5rem;">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <form action="<?php echo e(route('chat.start')); ?>" method="POST" style="width: 100%;">
                            ...
                            <div class="form-group" style="margin-bottom: 1rem;">
                                ...
                                <input type="number" name="amount" id="amount-<?php echo e($offer->id); ?>"
                                       step="0.01" min="1" max="<?php echo e($offer->availableAmount); ?>"
                                ...
                                <small style="color: var(--color-text-muted); font-size: 0.8rem; display: block; margin-top: 0.25rem;">
                                    Disponible: $ <?php echo e(number_format($offer->availableAmount, 2)); ?> de $ <?php echo e(number_format($offer->amount, 2)); ?>

                                </small>
                            </div>

                            <div class="form-group" style="margin-bottom: 1rem;">
                                <textarea name="message" id="message-<?php echo e($offer->id); ?>" class="form-input form-textarea"
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn--primary btn--block btn--lg">
        ...
        <div style="margin-top: 1.5rem; text-align: center;">
            <button onclick="closeModal(<?php echo e($offer->id); ?>)" class="btn btn--ghost btn--sm">
                Cerrar
            </button>
        </div>
    </div>
