<?php $__env->startSection('title', 'Tipos de cambio'); ?>
...
<div class="container">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Actualizado: <?php echo e(now()->format('d/m/Y H:i')); ?></p>
        </div>
    </div>
    ...
    <div class="rates-grid">
        <?php $__currentLoopData = $rates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="rate-card rate-card--<?php echo e($rate->type); ?>">
                <div class="rate-card__header">
                    <span class="rate-card__type"><?php echo e(ucfirst($rate->type)); ?></span>
                    <span class="rate-card__source text-muted text-sm"><?php echo e($rate->source); ?></span>
                </div>
                <div class="rate-card__prices">
                    <div class="rate-price">
                        <span class="rate-price__label">Compra</span>
                        <span class="rate-price__value font-mono">Bs. <?php echo e(number_format($rate->buyPrice, 2)); ?></span>
                    </div>
                    <div class="rate-price rate-price--sell">
                        <span class="rate-price__label">Venta</span>
                        <span class="rate-price__value font-mono">Bs. <?php echo e(number_format($rate->sellPrice, 2)); ?></span>
                    </div>
                </div>
                <div class="rate-card__spread text-muted text-sm">
                    Spread: Bs. <?php echo e(number_format($rate->spread, 4)); ?>
        ...
        <div class="offers-table-wrapper">
            <table class="offers-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $rates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><span class="badge badge--<?php echo e($rate->type === 'oficial' ? 'active' : ($rate->type === 'paralelo' ? 'sell' : 'buy')); ?>"><?php echo e(ucfirst($rate->type)); ?></span></td>
                        <td class="font-mono"><?php echo e(number_format($rate->buyPrice, 4)); ?></td>
                        <td class="font-mono"><?php echo e(number_format($rate->sellPrice, 4)); ?></td>
                        <td class="font-mono text-muted"><?php echo e(number_format($rate->spread, 4)); ?></td>
                        <td class="text-sm"><?php echo e($rate->source); ?></td>
                        <td class="text-muted text-sm"><?php echo e(\Carbon\Carbon::parse($rate->updatedAt)->diffForHumans()); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\collatech\dolarapp\resources\views/exchange-rates/index.blade.php ENDPATH**/ ?>